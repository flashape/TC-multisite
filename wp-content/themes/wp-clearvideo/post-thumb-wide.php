<?php if ( function_exists('get_the_image')) {
	...
	if ( $solostream_img['url'] && get_option('solostream_show_thumbs') == 'yes' && get_post_meta( $post->ID, 'remove_thumb', true ) != 'Yes' ) { ?> 
		...
		?>
		<img class="<?php echo $solostream_img['class']; ?>" src="<?php bloginfo('template_directory'); ?>/scripts/timthumb.php?src=<?php echo $the_img_url; ?>&amp;w=630&amp;h=350&amp;zc=1" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
	<?php } 
} ?>