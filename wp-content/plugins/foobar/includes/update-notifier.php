...
define( 'NOTIFIER_PLUGIN_NAME', 'FooBar' ); // The plugin name
define( 'NOTIFIER_PLUGIN_SHORT_NAME', 'FooBar' ); // The plugin short name, only if needed to make the menu item fit. Remove this if not needed
define( 'NOTIFIER_PLUGIN_FOLDER_NAME', 'foobar' ); // The plugin folder name
define( 'NOTIFIER_PLUGIN_FILE_NAME', 'foobar.php' ); // The plugin folder name
define( 'NOTIFIER_PLUGIN_XML_FILE', 'http://themergency.com/updates/foobar-version.xml' ); // The remote notifier XML file containing the latest version of the plugin and changelog
