...
if (!class_exists("ThemeLayoutControlSettingTrans", false)) 
{
class ThemeLayoutControlSettingTrans
{
   ...
   * @access public
   */
  public function __construct($IsNew, $MarkedToDelete, $MarkedToDetach, $AdditionalData, $ID, $ThemeLayoutControlID, $SettingKey, $SettingValue, $EditDate, $EditedBy, $EnterDate, $EnteredBy, $DateTimeStamp, $SettingInfoID)
  {
    $this->IsNew = $IsNew;
